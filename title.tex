...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
    ...
    \vspace{0.2cm}
     \begin{minipage}{0.4\textwidth}
        ...
        {\begin{flushright}\huge\bfseries Evaluation of the Feasibility of a Fountain-Style Reactor
                           \end{flushright}}
        {\begin{flushright}\large\textit{Based on Current Molten Salt Reactor Pumping Technologies}\end{flushright}}
        \end{minipage}
    ...
    %------------------------------------------------
    \vspace{1cm}
    \textsc{\LARGE\bfseries UIUC-ARFC-2021-NN} % Replace YYYY with the year, NN with report index
    \vspace{0.5cm}
    ...
    {\large April 06, 2021} % January 1, 3000
